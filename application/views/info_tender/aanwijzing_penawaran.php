                ...
                <div class="card-header border-dark bg-white text-black">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if ($rup['id_jadwal_tender'] == 1) { ?>
                           ...
                           <?php  } else { ?>
                               <li class="nav-item">
                               <a class="nav-link active text-white" style="margin-left: 5px;" href="<?= base_url('tender_diikuti/aanwijzing_penawaran/' . $rup['id_url_rup']) ?>"><i class="fa fa-comments" aria-hidden="true"></i> Aanwijzing (Penawaran)</a>
                           </li>
                           <?php }
                           ?>
