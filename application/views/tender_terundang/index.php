            ...
            <div class="card border-primary">
                ...
                <div class="card-body">
                    <div class="alert alert-info shadow-lg" role="alert">
                        ...
                        <hr>
                        <small>1. Fiture ini adalah untuk melihat daftar paket pengadaan yang telah di umumkan oleh panitia sesuai dengan kualifikasi data yang ada pada Data Rekanan Tetap.</small><br>
                    ...
                    <div class="card border-dark shadow-lg">
                        ...
                        <input type="hidden" name="url_mengikuti_terbatas" value="<?= base_url('tender_terundang/ikuti_paket_terbatas/') ?>">
                        <div class="card-body">
                            ...
                            <div class="card border-danger shadow-lg">
                                <div class="card-header">
                                    ...
                                    <div class="tab-content p-3 border bg-light" id="nav-tabContent">
                                        ...
                                        <div class="tab-pane fade show" id="nav-tenderbatas" role="tabpanel" aria-labelledby="nav-tenderbatas-tab">
                                            <div class="card border-dark">
                                                <div class="card-header border-dark bg-primary d-flex justify-content-between align-items-center">
                                                    <div class="flex-grow-1 bd-highlight">
                                                        <span class="text-white">
