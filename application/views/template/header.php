            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        <a href="http://localhost/drt-jmto/administrator/dashboard" class="nav-link">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul aria-labelledby="dropdownSubMenu" class="dropdown-menu border-0 shadow">
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/identitas" class="dropdown-item">
                            ...
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/izin" class="dropdown-item">
                                    <i class="fas fa-clone mr-2"></i>
                                    Izin Perusahan
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/akta" class="dropdown-item">
                                    <i class="fas fa-file-alt mr-2"></i>
                                    Akta Pendirian
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/menejerial" class="dropdown-item">
                                    <i class="fas fa-sitemap mr-2"></i>
                                    Manajerial
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/sdm" class="dropdown-item">
                                    <i class="fas fa-users mr-2"></i>
                                    Sumber Daya Manusia (SDM)
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/pengalaman" class="dropdown-item">
                                    <i class="fas fa-briefcase mr-2"></i>
                                    Pengalaman
                                </a>
                            </li>
                            <li>
                                <a href="http://localhost/drt-jmto/administrator/pajak" class="dropdown-item">
